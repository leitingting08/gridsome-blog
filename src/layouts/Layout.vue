<template>
    <div>
        <section class="page-header" :style="'background-image: linear-gradient(120deg, '+backgroundColorLeft+', '+backgroundColorRight+');color: '+fontColor+';'">
            ...
            <a href="https://github.com/leitingting08/gridsome-blog" class="btn" target="_blank" v-if="!mini">博客源码</a>
        </section>
            ...
            <el-card shadow="never" :body-style="{ padding: '0px' }">
                <el-row>
                    ...
                    <el-col :span="2" style="text-align: center;">
                        <img v-popover:bigAvatar :src="avatarUrl" @error="defImg" style="margin-top: 4px;margin-right: 10px;width:52px; height:52px; border-radius:5px; border: 1px solid #EBEEF5"
                        />
                        <el-popover ref="bigAvatar" placement="top-start" :title="githubUsername" width="200" trigger="hover">
                            ...
                            <br>
                            <img :src="avatarUrl" style="width: 200px;height: 200px;" @error="defImg">
                        </el-popover>
                    </el-col>
                </el-row>
...
<script>
    ...
    export default {
        ...
        data() {
            return {
                defaultAvatar: require("../assets/o_morty.png"),
                music: {
                    isPlay: false,
                    currentTime: 0,
                    maxTime: 0,
